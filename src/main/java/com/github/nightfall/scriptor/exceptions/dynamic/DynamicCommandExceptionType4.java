 ...
 * dynamically based on four input arguments.
 *
 * This class uses a functional approach, where the error message is generated by applying a {@link Function}
 * to four input objects.
 *
 * @see CommandExceptionType
 * @see CommandSyntaxException
 * @see Function
 * @author M4ximumpizza
 * @version 1.0
 */
public class DynamicCommandExceptionType4 implements CommandExceptionType {

    /** The function used to generate the error message. */
    private final Function function;

    /**
     * Constructs a new {@code Dynamic4CommandExceptionType} with the specified function for generating error messages.
     *
     * @param function the function that takes four objects and returns a {@link Message} for the exception
     */
    public DynamicCommandExceptionType4(final Function function) {
     ...
     * @param c the third argument for generating the error message
     * @param d the fourth argument for generating the error message
     ...
     * It takes four objects as input and returns a {@link Message}.
     */
